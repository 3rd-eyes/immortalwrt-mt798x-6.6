...
int cr_set_usage(int level)
{
	...
	pr_info("              13    0~1        Set hnat disable/enable ipv6\n");
	pr_info("              14    0~1        Set hnat disable/enable guest (rax1/ra1)\n");
	pr_info("              15     0~1        Set hnat disable/enable dscp setting\n");
	pr_info("              16     1~30       Set hnat bind rate\n");
...
static const debugfs_write_func cr_set_func[] = {
	...
	[13] = set_ipv6_toggle,   [14] = set_guest_toggle,
	[15] = set_dscp_toggle,  [16] = bind_rate_setting,
};
