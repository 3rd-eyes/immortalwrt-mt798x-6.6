...
int cr_set_usage(int level)
{
	...
	pr_info("              9     0~1        Set hnat disable/enable ipv6\n");
	pr_info("              10     0~1        Set hnat disable/enable guest (rax1/ra1)\n");
	pr_info("              11     0~1        Set hnat disable/enable dscp setting\n");
	pr_info("              12     1~30       Set hnat bind rate\n");
...
static const debugfs_write_func cr_set_func[] = {
	...
	[8] = set_hash_simple_mode,[9] = set_ipv6_toggle,
	[10] = set_guest_toggle,[11] = set_dscp_toggle,
	[12] = bind_rate_setting,
};
